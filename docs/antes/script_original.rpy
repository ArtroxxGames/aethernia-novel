...
define voces_alteradas = Character("Voces alteradas")
define soldado_desconocido = Character("Soldado desconocido")
...
image tocan_puerta = Transform(
    "images/tocan_puerta.jpg",
    xysize=(1920, 1080)
)

image soldados_entrando = Transform(
    "images/soldados_entrando.jpg",
    xysize=(1920, 1080)
)
...
label start:
    ...
    scene tocan_puerta
    voces_alteradas "¡Su majestad! ¡Su majestad!"

    rey "Adelante, pueden pasar"

    scene soldados_entrando
    soldado_desconocido "¡Su Majestad! Le pedimos disculpas por esta intromisión tan abrupta a sus aposentos, pero tenemos malas noticias."

    soldado_desconocido "En el Bosque de la Niebla han sido avistadas unas extrañas bestias deformes que atacaron el campamento de uno de nuestros grupos que resguardan el bosque."

    soldado_desconocido "Estas criaturas nos superan enormemente en velocidad y fuerza, sin mencionar que realizan magia única."

    soldado_desconocido "Por favor, señor, denos sus órdenes."
